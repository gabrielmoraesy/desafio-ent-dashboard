...
export function useNpsUnitChart({ npsUnitData, setUnitSelected }: useNpsUnitChartProps) {
  ...
  useEffect(() => {
    if (npsUnitData && npsUnitData.length > 0) {
      const axisColor = theme === "dark" ? "#fff" : "#000"; // Definir a cor com base no tema
        ...
        options: {
          ...
          xaxis: {
            ...
            labels: {
              ...
              style: {
                colors: axisColor, // Aplica a cor no xaxis conforme o tema
                fontSize: "12px",
              },
            },
          },
          yaxis: {
            ...
            labels: {
              ...
              style: {
                colors: axisColor, // Aplica a cor no yaxis conforme o tema
                fontSize: "12px",
              },
            },
          },
          legend: {
            ...prev.options.legend,
            labels: {
              colors: axisColor, // Aplica a cor da legenda conforme o tema
            },
          },
        },
      }));
